...
/**
 * @brief Ceres abstract functor to use a Pinhole_Intrinsic_Radial_K3_Rational
 *
 *  Data parameter blocks are the following <2,6,6,3>
 *  - 2 => dimension of the residuals,
 *  - 6 => the intrinsic data block [focal, principal point x, principal point y, K1, K2, K3],
 ...
 */
template <class Impl>
struct ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational
{
protected:

  explicit ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational(const double* const pos_2dpoint)
  :m_pos_2dpoint(pos_2dpoint)
  {
  }
public:
  ...
  )
  {
    if (weight == 0.0)
    {
      return
        (new ceres::AutoDiffCostFunction
          <T, 2, 6, 6, 3>(
            new T(observation.data())));
    }
    else
    {
      return
        (new ceres::AutoDiffCostFunction
          <WeightedCostFunction<T>, 2, 6, 6, 3>
          (new WeightedCostFunction<T>
            (new T(observation.data()), weight)));
    }
  }
...
/**
 * @brief Ceres abstract functor to use a ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational_2
 *
 *  Data parameter blocks are the following <2,6,6,3>
 *  - 2 => dimension of the residuals,
 *  - 6 => the intrinsic data block [focal, principal point x, principal point y, K1, K2, K3],
 ...
 *
 */
struct ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational_2 : public ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational<ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational_2>
{
  explicit ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational_2(const double* const pos_2dpoint)
  ...
  )
  {
    return ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational::Create
      <ResidualErrorFunctor_Pinhole_Intrinsic_Radial_K3_Rational_2>(observation, weight);
  }
};
